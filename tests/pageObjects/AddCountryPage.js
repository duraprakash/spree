class AddCountryPage {
    constructor(){
        this.countryNameFieldSelector = "#country_name";
        ...
        this.countryStateReqCheckboxSelector = "label[for='country_states_required']";
        this.createCountrySelector = "//button[@type='submit']";
        this.countrySelector = "//td[text()='%s']";
        this.profileIconSelector = "(//*[name()='path'])[8]";
        this.adminPanelMenuSelector = "//a[contains(@class, 'dropdown-item text-uppercase')]";
    ...
    async addCountry(countryName, countryIsoName, countryIso, countryIso3){
        ...
        await page.fill(this.countryNameFieldSelector, countryName);
        ...
        await page.locator(this.countryStateReqCheckboxSelector).click();
